...
const Header = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center text-center my-20'>
        ...
        <button onClick={onClickHandler} className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex item-center gap-2 rounded-full hover:scale-105 transition-all duration-500'>Generate Images
