...
const NavBar = () => {
    ...
    const {user, setShowLogin, logout, credit, loadCreditData} = useContext(AppContext);
            ...
            <div>
                {user ?
                    <div className='flex items-center gap-2 sm:gap-3'>
                        ...
                        } className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 rounded-full duration-500'>
